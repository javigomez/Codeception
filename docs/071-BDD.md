...
Scenarios are live examples of a Feature usage. 

Inside a `.feature` file, Scenarios should be written inside a *Feature* block. Each scenario should contain its title:
...
At the beginning the Scenario should describe its context with the **Given** keyword:
